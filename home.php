...
$query_chart = mysqli_query($conn, "SELECT nama_menu, daftar_menu.id, SUM(list_order.jumlah) AS total_jumlah FROM daftar_menu 
LEFT JOIN list_order ON daftar_menu.id = list_order.menu 
GROUP BY daftar_menu.id ORDER BY daftar_menu.id ASC");
