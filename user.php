                                 ...
                                 <div class="row">
                                     <div class="col-lg-4">
                                         <div class="form-floating mb-3">
                                             ...
                                             <label for="floatingInput">LevelUser</label>
                                             <div class="invalid-feedback">
                                                 Pilih Level User
                                             </div>
                                         </div>
                             ...
                             <div class="modal-body">
                                 <form action="proses/proses_input_user.php" method="POST" class="needs-validation" novalidate>
                                     <div class="row">
                                         ...
                                         <div class="col-lg-6">
                                             <div class="form-floating mb-3">
                                                 <input disabled type="text" class="form-control" id="floatingInput" placeholder="YourName" name="username" value="<?php echo $row['username'] ?>">
                                                 <label for="floatingInput">Username</label>
                                                 <div class="invalid-feedback">
                                                     Masukkan Username
                                                 </div>
                                         ...
                                         <div class="col-lg-4">
                                             <div class="form-floating mb-3">
                                                 <select disabled class="form-select" aria-label="Deafult select example" required name="level" id="">
                                                     <?php
                             ...
                             <div class="modal-body">
                                 <form action="proses/proses_edit_user.php" method="POST" class="needs-validation" novalidate>
                                     ...
                                     <div class="row">
                                         ...
                                         <div class="col-lg-6">
                                             <div class="form-floating mb-3">
                                                 <input <?php echo ($row['username'] == $_SESSION['username_pakresto']) ? 'disabled' : ''; ?>
                                                     type="email" class="form-control" id="floatingInput"
                                                     placeholder="YourName" name="username" required value="<?php echo $row['username'] ?>">
                                                 <label for="floatingInput">Username</label>
                                                 <div class="invalid-feedback">
                                                     Masukkan Username
                                                 </div>
                                         ...
                                         <div class="col-lg-4">
                                             <div class="form-floating mb-3">
                                                 <select class="form-select" aria-label="Deafult select example" required name="level" id="">
                                                     <?php
                                                        $data = array("Owner/Admin", "Kasir", "Pelayan", "Dapur");
                                                        foreach ($data as $key => $value) {
                                                            if ($row['level'] == $key + 1) {
                                         ...
                                         <div class="col-lg-8">
                                             <div class="form-floating mb-3">
                                                 <input type="number" class="form-control" id="floatingInput" placeholder="08xxxxxxxxxx" required name="nohp" value="<?php echo $row['nohp'] ?>">
                                                 <label for="floatingInput">No Hp</label>
                                             </div>
                                         </div>
                                     </div>
