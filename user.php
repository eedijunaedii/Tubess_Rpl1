                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_edit_user.php"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-floating mb-3">
                                                <input <?php echo ($row['username'] == $_SESSION['username_pakresto']) ?
                                ...
                                <form class="needs-validation" novalidate action="proses/proses_delete_user.php"
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-danger" name="input_user_validate"
                                            value="12345" <?php echo ($row['username'] == $_SESSION['username_pakresto']) ?
                                ...
                                <form class="needs-validation" novalidate action="proses/proses_reset_password.php"
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        if ($row['username'] == $_SESSION['username_pakresto']) {
                                            ...
                                            echo "apakah anda yakin ingin Mereset user <b> $row[username]</b> menajadi password bawaan sistem yaitu <b>password</b>";
                                        }
                                        ?>
